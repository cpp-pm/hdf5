...
/******************************/
H5_DLL herr_t   H5R__create_object(const void *obj_token, size_t token_size, struct href *ref);
H5_DLL herr_t   H5R__create_region(const void *obj_token, size_t token_size, H5S_t *space, struct href *ref);
H5_DLL herr_t   H5R__create_attr(const void *obj_token, size_t token_size, const char *attr_name, struct href *ref);
...
H5_DLL herr_t   H5R__get_obj_token(const struct href *ref, void *obj_token, size_t *token_size);
...
H5_DLL herr_t   H5R__encode(const char *filename, const struct href *ref, unsigned char *buf, size_t *nalloc, unsigned flags);
