...
/* Blob functions */
H5_DLL herr_t H5VL_blob_put(const H5VL_class_t *cls, const void *blob, size_t size, void *ctx, void *id);
H5_DLL herr_t H5VL_blob_get(const H5VL_class_t *cls, const void *id, void *ctx, void *blob, size_t *size);
H5_DLL herr_t H5VL_blob_specific(const H5VL_class_t *cls, const void *id, H5VL_blob_specific_t specific_type, ...);
