...
if (HDF5_ENABLE_Z_LIB_SUPPORT)
  if (NOT H5_ZLIB_HEADER)
    if (NOT ZLIB_USE_EXTERNAL)
      ...
      find_package (ZLIB NAMES ${ZLIB_PACKAGE_NAME}${HDF_PACKAGE_EXT} COMPONENTS static shared CONFIG)
      if (NOT ZLIB_FOUND)
...
if (HDF5_ENABLE_SZIP_SUPPORT)
  ...
  if (NOT SZIP_USE_EXTERNAL)
    ...
    find_package (SZIP NAMES ${SZIP_PACKAGE_NAME}${HDF_PACKAGE_EXT} COMPONENTS static shared CONFIG)
    if (NOT SZIP_FOUND)
